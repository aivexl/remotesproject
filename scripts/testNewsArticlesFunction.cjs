// Script untuk test news articles function
...
async function testNewsFunction() {
  try {
    console.log('Testing news articles function...');

    const results = await getArticlesByCoinSymbol('BTC', 'newsroom');
    console.log('News results:', results.length);
